...
import { useGsapReveal, type GsapRevealConfig } from '@/hooks'
import { Section } from '../sections'
import { Typography } from '@/components/ui/typography'
import Link from 'next/link'
import { Button } from '@/components/ui/button'
import { servicePillars, approachSteps, technologies } from '@/config'
                ...
                <div className="grid gap-4 lg:grid-cols-3">
                    {servicePillars.map((service) => {
                        ...
                        return (
                            <article
                                key={service.title}
                                className="service-card flex min-h-128 flex-col items-start rounded-4xl border border-border/60 bg-background p-6 md:p-8"
                            >
